...
├── agents/                     # ← generated by AgentBuilderAgent
│   │                           #   (catalog-reused from `_shared/*` or synthesised on demand)
│   ├── APIFeaturePlannerAgent/v1/{agent_manifest.yaml, system_prompt.md, grading_criteria.yaml}
│   ├── FastAPICodeGenAgent/v1/...
│   ├── PytestRunnerAgent/v1/...
│   └── CodeReviewerAgent/v1/...
└── workflows/                  # ← generated by AgentBuilderAgent
    └── feature_delivery.yaml       # self-healing DAG (see below)
```
